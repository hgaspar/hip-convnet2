 ...
 *
 * Block size: (4, 32)
 * hipBlockIdx_y * 4 + hipThreadIdx_y determines pixel
 * hipBlockIdx_x * 32 * imgsPerThread + hipThreadIdx_x determines case batch
 *
 */
    ...
    if (checkCaseBounds) {
        if (numColors == 1) {
            if (imgsPerThread == 1) {
                ...
                hipLaunchKernel(HIP_KERNEL_NAME(kReflectH<1, 1, true>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), targets.getDevData(), imgSize, numCases);
            } else if (imgsPerThread == 2) {
                hipFuncSetCacheConfig(kReflectH<1, 2, true>, hipFuncCachePreferL1);
                hipLaunchKernel(HIP_KERNEL_NAME(kReflectH<1, 2, true>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), targets.getDevData(), imgSize, numCases);
            } else if (imgsPerThread == 4) {
                hipFuncSetCacheConfig(kReflectH<1, 4, true>, hipFuncCachePreferL1);
                hipLaunchKernel(HIP_KERNEL_NAME(kReflectH<1, 4, true>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), targets.getDevData(), imgSize, numCases);
            }
        } else if (numColors == 2) {
            if (imgsPerThread == 1) {
                hipFuncSetCacheConfig(kReflectH<2, 1, true>, hipFuncCachePreferL1);
                hipLaunchKernel(HIP_KERNEL_NAME(kReflectH<2, 1, true>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), targets.getDevData(), imgSize, numCases);
            } else if (imgsPerThread == 2) {
                hipFuncSetCacheConfig(kReflectH<2, 2, true>, hipFuncCachePreferL1);
                hipLaunchKernel(HIP_KERNEL_NAME(kReflectH<2, 2, true>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), targets.getDevData(), imgSize, numCases);
            } else if (imgsPerThread == 4) {
                hipFuncSetCacheConfig(kReflectH<2, 4, true>, hipFuncCachePreferL1);
                hipLaunchKernel(HIP_KERNEL_NAME(kReflectH<2, 4, true>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), targets.getDevData(), imgSize, numCases);
            }
        } else if (numColors == 3) {
            if (imgsPerThread == 1) {
                hipFuncSetCacheConfig(kReflectH<3, 1, true>, hipFuncCachePreferL1);
                hipLaunchKernel(HIP_KERNEL_NAME(kReflectH<3, 1, true>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), targets.getDevData(), imgSize, numCases);
            } else if (imgsPerThread == 2) {
                hipFuncSetCacheConfig(kReflectH<3, 2, true>, hipFuncCachePreferL1);
                hipLaunchKernel(HIP_KERNEL_NAME(kReflectH<3, 2, true>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), targets.getDevData(), imgSize, numCases);
            } else if (imgsPerThread == 4) {
                hipFuncSetCacheConfig(kReflectH<3, 4, true>, hipFuncCachePreferL1);
                hipLaunchKernel(HIP_KERNEL_NAME(kReflectH<3, 4, true>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), targets.getDevData(), imgSize, numCases);
            }
        }
    } else {
        if (numColors == 1) {
            if (imgsPerThread == 1) {
                ...
                hipLaunchKernel(HIP_KERNEL_NAME(kReflectH<1, 1, false>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), targets.getDevData(), imgSize, numCases);
            } else if (imgsPerThread == 2) {
                hipFuncSetCacheConfig(kReflectH<1, 2, false>, hipFuncCachePreferL1);
                hipLaunchKernel(HIP_KERNEL_NAME(kReflectH<1, 2, false>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), targets.getDevData(), imgSize, numCases);
            } else if (imgsPerThread == 4) {
                hipFuncSetCacheConfig(kReflectH<1, 4, false>, hipFuncCachePreferL1);
                hipLaunchKernel(HIP_KERNEL_NAME(kReflectH<1, 4, false>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), targets.getDevData(), imgSize, numCases);
            }
        } else if (numColors == 2) {
            if (imgsPerThread == 1) {
                hipFuncSetCacheConfig(kReflectH<2, 1, false>, hipFuncCachePreferL1);
                hipLaunchKernel(HIP_KERNEL_NAME(kReflectH<2, 1, false>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), targets.getDevData(), imgSize, numCases);
            } else if (imgsPerThread == 2) {
                hipFuncSetCacheConfig(kReflectH<2, 2, false>, hipFuncCachePreferL1);
                hipLaunchKernel(HIP_KERNEL_NAME(kReflectH<2, 2, false>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), targets.getDevData(), imgSize, numCases);
            } else if (imgsPerThread == 4) {
                hipFuncSetCacheConfig(kReflectH<2, 4, false>, hipFuncCachePreferL1);
                hipLaunchKernel(HIP_KERNEL_NAME(kReflectH<2, 4, false>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), targets.getDevData(), imgSize, numCases);
            }
        } else if (numColors == 3) {
            if (imgsPerThread == 1) {
                hipFuncSetCacheConfig(kReflectH<3, 1, false>, hipFuncCachePreferL1);
                hipLaunchKernel(HIP_KERNEL_NAME(kReflectH<3, 1, false>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), targets.getDevData(), imgSize, numCases);
            } else if (imgsPerThread == 2) {
                hipFuncSetCacheConfig(kReflectH<3, 2, false>, hipFuncCachePreferL1);
                hipLaunchKernel(HIP_KERNEL_NAME(kReflectH<3, 2, false>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), targets.getDevData(), imgSize, numCases);
            } else if (imgsPerThread == 4) {
                hipFuncSetCacheConfig(kReflectH<3, 4, false>, hipFuncCachePreferL1);
                hipLaunchKernel(HIP_KERNEL_NAME(kReflectH<3, 4, false>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), targets.getDevData(), imgSize, numCases);
            }
        }
    }
...
void normalizeLocalWeights(NVMatrix& weights, int numModules, float norm) {
    ...
    if (filtersPerThread == 4) {
        ...
        hipLaunchKernel(HIP_KERNEL_NAME(kNormalizeLCWeights<4, 32, 4>), dim3(blocks), dim3(threads), 0, stream, weights.getDevData(), numFilters, numModules, weightsPerFilter, norm);
    } else if (filtersPerThread == 2) {
        hipFuncSetCacheConfig(kNormalizeLCWeights<4, 32, 2>, hipFuncCachePreferL1);
        hipLaunchKernel(HIP_KERNEL_NAME(kNormalizeLCWeights<4, 32, 2>), dim3(blocks), dim3(threads), 0, stream, weights.getDevData(), numFilters, numModules, weightsPerFilter, norm);
    } else {
        if (numFilters % 32 == 0) {
            hipFuncSetCacheConfig(kNormalizeLCWeights<4, 32, 1>, hipFuncCachePreferL1);
            hipLaunchKernel(HIP_KERNEL_NAME(kNormalizeLCWeights<4, 32, 1>), dim3(blocks), dim3(threads), 0, stream, weights.getDevData(), numFilters, numModules, weightsPerFilter, norm);
        } else {
            hipFuncSetCacheConfig(kNormalizeLCWeights<8, 16, 1>, hipFuncCachePreferL1);
            hipLaunchKernel(HIP_KERNEL_NAME(kNormalizeLCWeights<8, 16, 1>), dim3(blocks), dim3(threads), 0, stream, weights.getDevData(), numFilters, numModules, weightsPerFilter, norm);
        }
    }
}
    ...
    if (imgsPerThread == 4) {
        if (chansPerThread == 1) {
            if (checkCaseBounds) {
                ...
                hipLaunchKernel(HIP_KERNEL_NAME(kBedOfNails<4, 32, 4, 1, true>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), target.getDevData(),
                ...
                hipLaunchKernel(HIP_KERNEL_NAME(kBedOfNails<4, 32, 4, 1, false>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), target.getDevData(),
                                                                     imgSize, numChannels, numImages, startX, strideX, outputsX,
                                                                     reverse, scaleTargets, scaleOutput);
            }
        } else {
            if (checkCaseBounds) {
                ...
                hipLaunchKernel(HIP_KERNEL_NAME(kBedOfNails<4, 32, 4, 2, true>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), target.getDevData(),
                                                                    imgSize, numChannels, numImages, startX, strideX, outputsX,
                                                                    reverse, scaleTargets, scaleOutput);
            } else {
                hipFuncSetCacheConfig(kBedOfNails<4, 32, 4, 2, false>, hipFuncCachePreferL1);
                hipLaunchKernel(HIP_KERNEL_NAME(kBedOfNails<4, 32, 4, 2, false>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), target.getDevData(),
                                                                     imgSize, numChannels, numImages, startX, strideX, outputsX,
                                                                     reverse, scaleTargets, scaleOutput);
            }
        }
        ...
        if (chansPerThread == 1) {
            if (checkCaseBounds) {
                ...
                hipLaunchKernel(HIP_KERNEL_NAME(kBedOfNails<4, 32, 2, 1, true>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), target.getDevData(),
                                                                    imgSize, numChannels, numImages, startX, strideX, outputsX,
                                                                    reverse, scaleTargets, scaleOutput);
            } else {
                hipFuncSetCacheConfig(kBedOfNails<4, 32, 2, 1, false>, hipFuncCachePreferL1);
                hipLaunchKernel(HIP_KERNEL_NAME(kBedOfNails<4, 32, 2, 1, false>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), target.getDevData(),
                                                                     imgSize, numChannels, numImages, startX, strideX, outputsX,
                                                                     reverse, scaleTargets, scaleOutput);
            }
        } else {
            if (checkCaseBounds) {
                ...
                hipLaunchKernel(HIP_KERNEL_NAME(kBedOfNails<4, 32, 2, 2, true>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), target.getDevData(),
                                                                    imgSize, numChannels, numImages, startX, strideX, outputsX,
                                                                    reverse, scaleTargets, scaleOutput);
            } else {
                hipFuncSetCacheConfig(kBedOfNails<4, 32, 2, 2, false>, hipFuncCachePreferL1);
                hipLaunchKernel(HIP_KERNEL_NAME(kBedOfNails<4, 32, 2, 2, false>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), target.getDevData(),
                                                                     imgSize, numChannels, numImages, startX, strideX, outputsX,
                                                                     reverse, scaleTargets, scaleOutput);
            }
        }
        ...
        if (chansPerThread == 1) {
            if (checkCaseBounds) {
                ...
                hipLaunchKernel(HIP_KERNEL_NAME(kBedOfNails<4, 32, 1, 1, true>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), target.getDevData(),
                                                                    imgSize, numChannels, numImages, startX, strideX, outputsX,
                                                                    reverse, scaleTargets, scaleOutput);
            } else {
                hipFuncSetCacheConfig(kBedOfNails<4, 32, 1, 1, false>, hipFuncCachePreferL1);
                hipLaunchKernel(HIP_KERNEL_NAME(kBedOfNails<4, 32, 1, 1, false>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), target.getDevData(),
                                                                     imgSize, numChannels, numImages, startX, strideX, outputsX,
                                                                     reverse, scaleTargets, scaleOutput);
            }
        } else {
            if (checkCaseBounds) {
                ...
                hipLaunchKernel(HIP_KERNEL_NAME(kBedOfNails<4, 32, 1, 2, true>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), target.getDevData(),
                                                                    imgSize, numChannels, numImages, startX, strideX, outputsX,
                                                                    reverse, scaleTargets, scaleOutput);
            } else {
                hipFuncSetCacheConfig(kBedOfNails<4, 32, 1, 2, false>, hipFuncCachePreferL1);
                hipLaunchKernel(HIP_KERNEL_NAME(kBedOfNails<4, 32, 1, 2, false>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), target.getDevData(),
                                                                     imgSize, numChannels, numImages, startX, strideX, outputsX,
                                                                     reverse, scaleTargets, scaleOutput);
            }
        }
...
void convGaussianBlur(NVMatrix& images, NVMatrix& filter, NVMatrix& target, bool horiz, int numChannels,
    ...
    if (radius == 1) {
        ...
        hipLaunchKernel(HIP_KERNEL_NAME(kGaussianBlur<4, 32, 1>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), filter.getDevData(), target.getDevData(),
        ...
        hipLaunchKernel(HIP_KERNEL_NAME(kGaussianBlur<4, 32, 2>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), filter.getDevData(), target.getDevData(),
                                                           imgSize, numImages, images.getStride(), numChannels,horiz, scaleTargets, scaleOutputs);

    } else if (radius == 3) {
        hipFuncSetCacheConfig(kGaussianBlur<4, 32, 3>, hipFuncCachePreferL1);
        hipLaunchKernel(HIP_KERNEL_NAME(kGaussianBlur<4, 32, 3>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), filter.getDevData(), target.getDevData(),
                                                           imgSize, numImages, images.getStride(), numChannels,horiz, scaleTargets, scaleOutputs);
    } else if (radius == 4) {
        hipFuncSetCacheConfig(kGaussianBlur<4, 32, 4>, hipFuncCachePreferL1);
        hipLaunchKernel(HIP_KERNEL_NAME(kGaussianBlur<4, 32, 4>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), filter.getDevData(), target.getDevData(),
                                                           imgSize, numImages, images.getStride(), numChannels,horiz, scaleTargets, scaleOutputs);
    }
}
...
/*
 * Block size B_YxB_X
 * hipBlockIdx_x determines image idx in batches of B_X*imgsPerThread
 * hipBlockIdx_y determines filter idx in batches of B_Y*filtersPerThread
 * hipBlockIdx_z determines pixel
 *
...
__global__ void kCNorm_manyfilter(float* imgs, float* meanDiffs, float* denoms, float* target, const int imgSize,
    ...
    const int pxIdxX = hipBlockIdx_z % imgSize;
    const int pxIdxY = hipBlockIdx_z / imgSize;
    const int blockImgIdx = hipBlockIdx_x * B_X * imgsPerThread;
    const int blockFilterIdx = hipBlockIdx_y * B_Y * filtersPerThread;
...
//    assert(numImages % 128 == 0);
    ...
    if (scaleTargets == 0) {
        ...
        if (!checkCaseBounds) {
            if (imgsPerThread == 4) {
                hipLaunchKernel(HIP_KERNEL_NAME(kCrossMapMaxPoolUndo<4, 32, 4, false, false>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), maxGrads.getDevData(), maxActs.getDevData(), target.getDevData(),
                                                                                             imgSize, numFilters, numImages, startF, poolSize, numOutputs, stride,
                                                                                             scaleTargets, scaleOutputs);
            } else if (imgsPerThread == 2) {
                hipLaunchKernel(HIP_KERNEL_NAME(kCrossMapMaxPoolUndo<4, 32, 2, false, false>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), maxGrads.getDevData(), maxActs.getDevData(), target.getDevData(),
                                                                                             imgSize, numFilters, numImages, startF, poolSize, numOutputs, stride,
                                                                                             scaleTargets, scaleOutputs);
            } else {
                hipLaunchKernel(HIP_KERNEL_NAME(kCrossMapMaxPoolUndo<4, 32, 1, false, false>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), maxGrads.getDevData(), maxActs.getDevData(), target.getDevData(),
                                                                                             imgSize, numFilters, numImages, startF, poolSize, numOutputs, stride,
                                                                                             scaleTargets, scaleOutputs);
            }
        } else {
            hipLaunchKernel(HIP_KERNEL_NAME(kCrossMapMaxPoolUndo<4, 32, 1, false, true>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), maxGrads.getDevData(), maxActs.getDevData(), target.getDevData(),
                                                                                         imgSize, numFilters, numImages, startF, poolSize, numOutputs, stride,
                                                                                         scaleTargets, scaleOutputs);
        }
    } else {
        ...
        if (!checkCaseBounds) {
            if (imgsPerThread == 4) {
                hipLaunchKernel(HIP_KERNEL_NAME(kCrossMapMaxPoolUndo<4, 32, 4, true, false>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), maxGrads.getDevData(), maxActs.getDevData(), target.getDevData(),
                                                                                             imgSize, numFilters, numImages, startF, poolSize, numOutputs, stride,
                                                                                             scaleTargets, scaleOutputs);
            } else if (imgsPerThread == 2) {
                hipLaunchKernel(HIP_KERNEL_NAME(kCrossMapMaxPoolUndo<4, 32, 2, true, false>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), maxGrads.getDevData(), maxActs.getDevData(), target.getDevData(),
                                                                                             imgSize, numFilters, numImages, startF, poolSize, numOutputs, stride,
                                                                                             scaleTargets, scaleOutputs);
            } else {
                hipLaunchKernel(HIP_KERNEL_NAME(kCrossMapMaxPoolUndo<4, 32, 1, true, false>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), maxGrads.getDevData(), maxActs.getDevData(), target.getDevData(),
                                                                                             imgSize, numFilters, numImages, startF, poolSize, numOutputs, stride,
                                                                                             scaleTargets, scaleOutputs);
            }
        } else {
            hipLaunchKernel(HIP_KERNEL_NAME(kCrossMapMaxPoolUndo<4, 32, 1, true, true>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), maxGrads.getDevData(), maxActs.getDevData(), target.getDevData(),
                                                                                         imgSize, numFilters, numImages, startF, poolSize, numOutputs, stride,
                                                                                         scaleTargets, scaleOutputs);
        }
    }
    ...
    if (imgsPerThread == 4) {
        if  (checkCaseBounds) {
            if (scaleTargets == 0 && scaleOutput == 1) {
                hipLaunchKernel(HIP_KERNEL_NAME(kLocalMaxUndo<4, 32, 4, 2, false, true>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), maxGrads.getDevData(), maxActs.getDevData(), target.getDevData(),
                                                                imgSize, numFilters, numImages, subsX, startX, strideX, outputsX, scaleTargets, scaleOutput);
            } else {
                hipLaunchKernel(HIP_KERNEL_NAME(kLocalMaxUndo<4, 32, 4, 2, true, true>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), maxGrads.getDevData(), maxActs.getDevData(), target.getDevData(),
                                                                imgSize, numFilters, numImages, subsX, startX, strideX, outputsX, scaleTargets, scaleOutput);
            }
        } else {
            if (scaleTargets == 0 && scaleOutput == 1) {
                hipLaunchKernel(HIP_KERNEL_NAME(kLocalMaxUndo<4, 32, 4, 2, false, false>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), maxGrads.getDevData(), maxActs.getDevData(), target.getDevData(),
                                                                imgSize, numFilters, numImages, subsX, startX, strideX, outputsX, scaleTargets, scaleOutput);
            } else {
                hipLaunchKernel(HIP_KERNEL_NAME(kLocalMaxUndo<4, 32, 4, 2, true, false>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), maxGrads.getDevData(), maxActs.getDevData(), target.getDevData(),
                                                                imgSize, numFilters, numImages, subsX, startX, strideX, outputsX, scaleTargets, scaleOutput);
            }
        }
    } else if (imgsPerThread == 2) {
        if  (checkCaseBounds) {
            if (scaleTargets == 0 && scaleOutput == 1) {
                hipLaunchKernel(HIP_KERNEL_NAME(kLocalMaxUndo<4, 32, 2, 2, false, true>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), maxGrads.getDevData(), maxActs.getDevData(), target.getDevData(),
                                                                imgSize, numFilters, numImages, subsX, startX, strideX, outputsX, scaleTargets, scaleOutput);
            } else {
                hipLaunchKernel(HIP_KERNEL_NAME(kLocalMaxUndo<4, 32, 2, 2, true, true>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), maxGrads.getDevData(), maxActs.getDevData(), target.getDevData(),
                                                                imgSize, numFilters, numImages, subsX, startX, strideX, outputsX, scaleTargets, scaleOutput);
            }
        } else {
            if (scaleTargets == 0 && scaleOutput == 1) {
                hipLaunchKernel(HIP_KERNEL_NAME(kLocalMaxUndo<4, 32, 2, 2, false, false>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), maxGrads.getDevData(), maxActs.getDevData(), target.getDevData(),
                                                                imgSize, numFilters, numImages, subsX, startX, strideX, outputsX, scaleTargets, scaleOutput);
            } else {
                hipLaunchKernel(HIP_KERNEL_NAME(kLocalMaxUndo<4, 32, 2, 2, true, false>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), maxGrads.getDevData(), maxActs.getDevData(), target.getDevData(),
                                                                imgSize, numFilters, numImages, subsX, startX, strideX, outputsX, scaleTargets, scaleOutput);
            }
        }
    } else {
        if  (checkCaseBounds) {
            if (scaleTargets == 0 && scaleOutput == 1) {
                hipLaunchKernel(HIP_KERNEL_NAME(kLocalMaxUndo<4, 32, 1, 2, false, true>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), maxGrads.getDevData(), maxActs.getDevData(), target.getDevData(),
                                                                imgSize, numFilters, numImages, subsX, startX, strideX, outputsX, scaleTargets, scaleOutput);
            } else {
                hipLaunchKernel(HIP_KERNEL_NAME(kLocalMaxUndo<4, 32, 1, 2, true, true>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), maxGrads.getDevData(), maxActs.getDevData(), target.getDevData(),
                                                                imgSize, numFilters, numImages, subsX, startX, strideX, outputsX, scaleTargets, scaleOutput);
            }
        } else {
            if (scaleTargets == 0 && scaleOutput == 1) {
                hipLaunchKernel(HIP_KERNEL_NAME(kLocalMaxUndo<4, 32, 1, 2, false, false>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), maxGrads.getDevData(), maxActs.getDevData(), target.getDevData(),
                                                                imgSize, numFilters, numImages, subsX, startX, strideX, outputsX, scaleTargets, scaleOutput);
            } else {
                hipLaunchKernel(HIP_KERNEL_NAME(kLocalMaxUndo<4, 32, 1, 2, true, false>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), maxGrads.getDevData(), maxActs.getDevData(), target.getDevData(),
                                                                imgSize, numFilters, numImages, subsX, startX, strideX, outputsX, scaleTargets, scaleOutput);
            }
        }
    }
...
//    assert(numImages % 128 == 0);
    ...
    if (sum) {
        if (imgsPerThread == 4) {
            if (checkCaseBounds) {
                if (scaleTargets == 0 && scaleOutput == 1) {
                    hipLaunchKernel(HIP_KERNEL_NAME(kLocalAvgUndo<4, 32, 4, 4, true, false, true>), dim3(blocks), dim3(threads), 0, stream, avgGrads.getDevData(), target.getDevData(), imgSize,
                            numFilters, numImages, subsX, startX, strideX, outputsX, scaleTargets, scaleOutput);
                } else {
                    hipLaunchKernel(HIP_KERNEL_NAME(kLocalAvgUndo<4, 32, 4, 4, true, true, true>), dim3(blocks), dim3(threads), 0, stream, avgGrads.getDevData(), target.getDevData(), imgSize,
                            numFilters, numImages, subsX, startX, strideX, outputsX, scaleTargets, scaleOutput);
                }
            } else {
                if (scaleTargets == 0 && scaleOutput == 1) {
                    hipLaunchKernel(HIP_KERNEL_NAME(kLocalAvgUndo<4, 32, 4, 4, true, false, false>), dim3(blocks), dim3(threads), 0, stream, avgGrads.getDevData(), target.getDevData(), imgSize,
                            numFilters, numImages, subsX, startX, strideX, outputsX, scaleTargets, scaleOutput);
                } else {
                    hipLaunchKernel(HIP_KERNEL_NAME(kLocalAvgUndo<4, 32, 4, 4, true, true, false>), dim3(blocks), dim3(threads), 0, stream, avgGrads.getDevData(), target.getDevData(), imgSize,
                            numFilters, numImages, subsX, startX, strideX, outputsX, scaleTargets, scaleOutput);
                }
            }
        } else if (imgsPerThread == 2) {
            if (checkCaseBounds) {
                if (scaleTargets == 0 && scaleOutput == 1) {
                    hipLaunchKernel(HIP_KERNEL_NAME(kLocalAvgUndo<4, 32, 2, 4, true, false, true>), dim3(blocks), dim3(threads), 0, stream, avgGrads.getDevData(), target.getDevData(), imgSize,
                            numFilters, numImages, subsX, startX, strideX, outputsX, scaleTargets, scaleOutput);
                } else {
                    hipLaunchKernel(HIP_KERNEL_NAME(kLocalAvgUndo<4, 32, 2, 4, true, true, true>), dim3(blocks), dim3(threads), 0, stream, avgGrads.getDevData(), target.getDevData(), imgSize,
                            numFilters, numImages, subsX, startX, strideX, outputsX, scaleTargets, scaleOutput);
                }
            } else {
                if (scaleTargets == 0 && scaleOutput == 1) {
                    hipLaunchKernel(HIP_KERNEL_NAME(kLocalAvgUndo<4, 32, 2, 4, true, false, false>), dim3(blocks), dim3(threads), 0, stream, avgGrads.getDevData(), target.getDevData(), imgSize,
                            numFilters, numImages, subsX, startX, strideX, outputsX, scaleTargets, scaleOutput);
                } else {
                    hipLaunchKernel(HIP_KERNEL_NAME(kLocalAvgUndo<4, 32, 2, 4, true, true, false>), dim3(blocks), dim3(threads), 0, stream, avgGrads.getDevData(), target.getDevData(), imgSize,
                            numFilters, numImages, subsX, startX, strideX, outputsX, scaleTargets, scaleOutput);
                }
            }
        } else {
            if (checkCaseBounds) {
                if (scaleTargets == 0 && scaleOutput == 1) {
                    hipLaunchKernel(HIP_KERNEL_NAME(kLocalAvgUndo<4, 32, 1, 4, true, false, true>), dim3(blocks), dim3(threads), 0, stream, avgGrads.getDevData(), target.getDevData(), imgSize,
                            numFilters, numImages, subsX, startX, strideX, outputsX, scaleTargets, scaleOutput);
                } else {
                    hipLaunchKernel(HIP_KERNEL_NAME(kLocalAvgUndo<4, 32, 1, 4, true, true, true>), dim3(blocks), dim3(threads), 0, stream, avgGrads.getDevData(), target.getDevData(), imgSize,
                            numFilters, numImages, subsX, startX, strideX, outputsX, scaleTargets, scaleOutput);
                }
            } else {
                if (scaleTargets == 0 && scaleOutput == 1) {
                    hipLaunchKernel(HIP_KERNEL_NAME(kLocalAvgUndo<4, 32, 1, 4, true, false, false>), dim3(blocks), dim3(threads), 0, stream, avgGrads.getDevData(), target.getDevData(), imgSize,
                            numFilters, numImages, subsX, startX, strideX, outputsX, scaleTargets, scaleOutput);
                } else {
                    hipLaunchKernel(HIP_KERNEL_NAME(kLocalAvgUndo<4, 32, 1, 4, true, true, false>), dim3(blocks), dim3(threads), 0, stream, avgGrads.getDevData(), target.getDevData(), imgSize,
                            numFilters, numImages, subsX, startX, strideX, outputsX, scaleTargets, scaleOutput);
                }
            }
        }
        ...
        if (imgsPerThread == 4) {
            if (checkCaseBounds) {
                if (scaleTargets == 0 && scaleOutput == 1) {
                    hipLaunchKernel(HIP_KERNEL_NAME(kLocalAvgUndo<4, 32, 4, 4, false, false, true>), dim3(blocks), dim3(threads), 0, stream, avgGrads.getDevData(), target.getDevData(), imgSize,
                            numFilters, numImages, subsX, startX, strideX, outputsX, scaleTargets, scaleOutput);
                } else {
                    hipLaunchKernel(HIP_KERNEL_NAME(kLocalAvgUndo<4, 32, 4, 4, false, true, true>), dim3(blocks), dim3(threads), 0, stream, avgGrads.getDevData(), target.getDevData(), imgSize,
                            numFilters, numImages, subsX, startX, strideX, outputsX, scaleTargets, scaleOutput);
                }
            } else {
                if (scaleTargets == 0 && scaleOutput == 1) {
                    hipLaunchKernel(HIP_KERNEL_NAME(kLocalAvgUndo<4, 32, 4, 4, false, false, false>), dim3(blocks), dim3(threads), 0, stream, avgGrads.getDevData(), target.getDevData(), imgSize,
                            numFilters, numImages, subsX, startX, strideX, outputsX, scaleTargets, scaleOutput);
                } else {
                    hipLaunchKernel(HIP_KERNEL_NAME(kLocalAvgUndo<4, 32, 4, 4, false, true, false>), dim3(blocks), dim3(threads), 0, stream, avgGrads.getDevData(), target.getDevData(), imgSize,
                            numFilters, numImages, subsX, startX, strideX, outputsX, scaleTargets, scaleOutput);
                }
            }
        } else if (imgsPerThread == 2) {
            if (checkCaseBounds) {
                if (scaleTargets == 0 && scaleOutput == 1) {
                    hipLaunchKernel(HIP_KERNEL_NAME(kLocalAvgUndo<4, 32, 2, 4, false, false, true>), dim3(blocks), dim3(threads), 0, stream, avgGrads.getDevData(), target.getDevData(), imgSize,
                            numFilters, numImages, subsX, startX, strideX, outputsX, scaleTargets, scaleOutput);
                } else {
                    hipLaunchKernel(HIP_KERNEL_NAME(kLocalAvgUndo<4, 32, 2, 4, false, true, true>), dim3(blocks), dim3(threads), 0, stream, avgGrads.getDevData(), target.getDevData(), imgSize,
                            numFilters, numImages, subsX, startX, strideX, outputsX, scaleTargets, scaleOutput);
                }
            } else {
                if (scaleTargets == 0 && scaleOutput == 1) {
                    hipLaunchKernel(HIP_KERNEL_NAME(kLocalAvgUndo<4, 32, 2, 4, false, false, false>), dim3(blocks), dim3(threads), 0, stream, avgGrads.getDevData(), target.getDevData(), imgSize,
                            numFilters, numImages, subsX, startX, strideX, outputsX, scaleTargets, scaleOutput);
                } else {
                    hipLaunchKernel(HIP_KERNEL_NAME(kLocalAvgUndo<4, 32, 2, 4, false, true, false>), dim3(blocks), dim3(threads), 0, stream, avgGrads.getDevData(), target.getDevData(), imgSize,
                            numFilters, numImages, subsX, startX, strideX, outputsX, scaleTargets, scaleOutput);
                }
            }
        } else {
            if (checkCaseBounds) {
                if (scaleTargets == 0 && scaleOutput == 1) {
                    hipLaunchKernel(HIP_KERNEL_NAME(kLocalAvgUndo<4, 32, 1, 4, false, false, true>), dim3(blocks), dim3(threads), 0, stream, avgGrads.getDevData(), target.getDevData(), imgSize,
                            numFilters, numImages, subsX, startX, strideX, outputsX, scaleTargets, scaleOutput);
                } else {
                    hipLaunchKernel(HIP_KERNEL_NAME(kLocalAvgUndo<4, 32, 1, 4, false, true, true>), dim3(blocks), dim3(threads), 0, stream, avgGrads.getDevData(), target.getDevData(), imgSize,
                            numFilters, numImages, subsX, startX, strideX, outputsX, scaleTargets, scaleOutput);
                }
            } else {
                if (scaleTargets == 0 && scaleOutput == 1) {
                    hipLaunchKernel(HIP_KERNEL_NAME(kLocalAvgUndo<4, 32, 1, 4, false, false, false>), dim3(blocks), dim3(threads), 0, stream, avgGrads.getDevData(), target.getDevData(), imgSize,
                            numFilters, numImages, subsX, startX, strideX, outputsX, scaleTargets, scaleOutput);
                } else {
                    hipLaunchKernel(HIP_KERNEL_NAME(kLocalAvgUndo<4, 32, 1, 4, false, true, false>), dim3(blocks), dim3(threads), 0, stream, avgGrads.getDevData(), target.getDevData(), imgSize,
                            numFilters, numImages, subsX, startX, strideX, outputsX, scaleTargets, scaleOutput);
                }
            }
        }
...
void convContrastNorm(NVMatrix& images, NVMatrix& meanDiffs, NVMatrix& denoms, NVMatrix& target, int numFilters, int sizeX, float addScale, float powScale, float minDiv) {
    ...
    if (sizeX >= 6 && numFilters % 4 == 0) {
        ...
        if (checkCaseBounds) {
            ...
            hipLaunchKernel(HIP_KERNEL_NAME(kCNorm2<8, 8, 4, true>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), meanDiffs.getDevData(), denoms.getDevData(), target.getDevData(),
            ...
            hipLaunchKernel(HIP_KERNEL_NAME(kCNorm2<8, 8, 4, false>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), meanDiffs.getDevData(), denoms.getDevData(), target.getDevData(),
                                                           imgSize, numFilters, numImages, sizeX, addScale, powScale, minDiv);
        }
    } else {
        ...
        if (numFilters <= 8) {
            ...
            if (numFilters == 1) {
                if (checkCaseBounds) {
                    ...
                    hipLaunchKernel(HIP_KERNEL_NAME(kCNorm_fewfilter<1, 1, true>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), meanDiffs.getDevData(), denoms.getDevData(), target.getDevData(),
                                                                      imgSize, numImages, sizeX, addScale, powScale, minDiv);
                } else {
                    hipFuncSetCacheConfig(kCNorm_fewfilter<1, 1, false>, hipFuncCachePreferL1);
                    hipLaunchKernel(HIP_KERNEL_NAME(kCNorm_fewfilter<1, 1, false>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), meanDiffs.getDevData(), denoms.getDevData(), target.getDevData(),
                                                                      imgSize, numImages, sizeX, addScale, powScale, minDiv);
                }
            } else  if (numFilters == 2) {
                if (checkCaseBounds) {
                    hipFuncSetCacheConfig(kCNorm_fewfilter<1, 2, true>, hipFuncCachePreferL1);
                    hipLaunchKernel(HIP_KERNEL_NAME(kCNorm_fewfilter<1, 2, true>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), meanDiffs.getDevData(), denoms.getDevData(), target.getDevData(),
                                                                      imgSize, numImages, sizeX, addScale, powScale, minDiv);
                } else {
                    hipFuncSetCacheConfig(kCNorm_fewfilter<1, 2, false>, hipFuncCachePreferL1);
                    hipLaunchKernel(HIP_KERNEL_NAME(kCNorm_fewfilter<1, 2, false>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), meanDiffs.getDevData(), denoms.getDevData(), target.getDevData(),
                                                                      imgSize, numImages, sizeX, addScale, powScale, minDiv);
                }
            } else  if (numFilters == 3) {
                if (checkCaseBounds) {
                    hipFuncSetCacheConfig(kCNorm_fewfilter<1, 3, true>, hipFuncCachePreferL1);
                    hipLaunchKernel(HIP_KERNEL_NAME(kCNorm_fewfilter<1, 3, true>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), meanDiffs.getDevData(), denoms.getDevData(), target.getDevData(),
                                                                      imgSize, numImages, sizeX, addScale, powScale, minDiv);
                } else {
                    hipFuncSetCacheConfig(kCNorm_fewfilter<1, 3, false>, hipFuncCachePreferL1);
                    hipLaunchKernel(HIP_KERNEL_NAME(kCNorm_fewfilter<1, 3, false>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), meanDiffs.getDevData(), denoms.getDevData(), target.getDevData(),
                                                                      imgSize, numImages, sizeX, addScale, powScale, minDiv);
                }
            } else  if (numFilters == 4) {
                if (checkCaseBounds) {
                    hipFuncSetCacheConfig(kCNorm_fewfilter<1, 4, true>, hipFuncCachePreferL1);
                    hipLaunchKernel(HIP_KERNEL_NAME(kCNorm_fewfilter<1, 4, true>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), meanDiffs.getDevData(), denoms.getDevData(), target.getDevData(),
                                                                      imgSize, numImages, sizeX, addScale, powScale, minDiv);
                } else {
                    hipFuncSetCacheConfig(kCNorm_fewfilter<1, 4, false>, hipFuncCachePreferL1);
                    hipLaunchKernel(HIP_KERNEL_NAME(kCNorm_fewfilter<1, 4, false>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), meanDiffs.getDevData(), denoms.getDevData(), target.getDevData(),
                                                                      imgSize, numImages, sizeX, addScale, powScale, minDiv);
                }
            } else  if (numFilters == 5) {
                if (checkCaseBounds) {
                    hipFuncSetCacheConfig(kCNorm_fewfilter<1, 5, true>, hipFuncCachePreferL1);
                    hipLaunchKernel(HIP_KERNEL_NAME(kCNorm_fewfilter<1, 5, true>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), meanDiffs.getDevData(), denoms.getDevData(), target.getDevData(),
                                                                      imgSize, numImages, sizeX, addScale, powScale, minDiv);
                } else {
                    hipFuncSetCacheConfig(kCNorm_fewfilter<1, 5, false>, hipFuncCachePreferL1);
                    hipLaunchKernel(HIP_KERNEL_NAME(kCNorm_fewfilter<1, 5, false>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), meanDiffs.getDevData(), denoms.getDevData(), target.getDevData(),
                                                                      imgSize, numImages, sizeX, addScale, powScale, minDiv);
                }
            } else  if (numFilters == 6) {
                if (checkCaseBounds) {
                    hipFuncSetCacheConfig(kCNorm_fewfilter<1, 6, true>, hipFuncCachePreferL1);
                    hipLaunchKernel(HIP_KERNEL_NAME(kCNorm_fewfilter<1, 6, true>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), meanDiffs.getDevData(), denoms.getDevData(), target.getDevData(),
                                                                      imgSize, numImages, sizeX, addScale, powScale, minDiv);
                } else {
                    hipFuncSetCacheConfig(kCNorm_fewfilter<1, 6, false>, hipFuncCachePreferL1);
                    hipLaunchKernel(HIP_KERNEL_NAME(kCNorm_fewfilter<1, 6, false>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), meanDiffs.getDevData(), denoms.getDevData(), target.getDevData(),
                                                                      imgSize, numImages, sizeX, addScale, powScale, minDiv);
                }
            } else  if (numFilters == 7) {
                if (checkCaseBounds) {
                    hipFuncSetCacheConfig(kCNorm_fewfilter<1, 7, true>, hipFuncCachePreferL1);
                    hipLaunchKernel(HIP_KERNEL_NAME(kCNorm_fewfilter<1, 7, true>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), meanDiffs.getDevData(), denoms.getDevData(), target.getDevData(),
                                                                      imgSize, numImages, sizeX, addScale, powScale, minDiv);
                } else {
                    hipFuncSetCacheConfig(kCNorm_fewfilter<1, 7, false>, hipFuncCachePreferL1);
                    hipLaunchKernel(HIP_KERNEL_NAME(kCNorm_fewfilter<1, 7, false>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), meanDiffs.getDevData(), denoms.getDevData(), target.getDevData(),
                                                                      imgSize, numImages, sizeX, addScale, powScale, minDiv);
                }
            } else  if (numFilters == 8) {
                if (checkCaseBounds) {
                    hipFuncSetCacheConfig(kCNorm_fewfilter<1, 8, true>, hipFuncCachePreferL1);
                    hipLaunchKernel(HIP_KERNEL_NAME(kCNorm_fewfilter<1, 8, true>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), meanDiffs.getDevData(), denoms.getDevData(), target.getDevData(),
                                                                      imgSize, numImages, sizeX, addScale, powScale, minDiv);
                } else {
                    hipFuncSetCacheConfig(kCNorm_fewfilter<1, 8, false>, hipFuncCachePreferL1);
                    hipLaunchKernel(HIP_KERNEL_NAME(kCNorm_fewfilter<1, 8, false>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), meanDiffs.getDevData(), denoms.getDevData(), target.getDevData(),
                                                                      imgSize, numImages, sizeX, addScale, powScale, minDiv);
                }
            }
        } else {
            ...
            if (checkCaseBounds) {
                ...
                hipLaunchKernel(HIP_KERNEL_NAME(kCNorm_manyfilter<4, 32, 4, 2, true>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), meanDiffs.getDevData(), denoms.getDevData(), target.getDevData(),
                                                                  imgSize, numFilters, numImages, sizeX, addScale, powScale, minDiv);
            } else {
                hipFuncSetCacheConfig(kCNorm_manyfilter<4, 32, 4, 2, false>, hipFuncCachePreferL1);
                hipLaunchKernel(HIP_KERNEL_NAME(kCNorm_manyfilter<4, 32, 4, 2, false>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), meanDiffs.getDevData(), denoms.getDevData(), target.getDevData(),
                                                                  imgSize, numFilters, numImages, sizeX, addScale, powScale, minDiv);
            }
        }
    }
...
void convResponseNormUndo(NVMatrix& outGrads, NVMatrix& denoms, NVMatrix& inputs, NVMatrix& acts, NVMatrix& target, int numFilters,
    ...
    hipStream_t stream = NVMatrix::getDefaultStream();
    hipLaunchKernel(HIP_KERNEL_NAME(kRNormUndoPrelims<128, 8>), dim3(blocks), dim3(threads), 0, stream, acts.getDevData(), denoms.getTextureObject(), outGrads.getTextureObject(), outGrads.getNumElements(), -2*addScale*powScale);
    ...
    if (sizeX >= 6 && numFilters % 4 == 0) {
        ...
        if (imgsPerThread == 8) {
            if (checkCaseBounds) {
                if (scaleTargets == 0 && scaleOutput == 1) {
                    ...
                    hipLaunchKernel(HIP_KERNEL_NAME(kRNormUndo2<16, 8, 4, true, true>), dim3(blocks), dim3(threads), 0, stream, outGrads.getDevData(), denoms.getDevData(), inputs.getDevData(), acts.getDevData(),
                    ...
                    hipLaunchKernel(HIP_KERNEL_NAME(kRNormUndo2<16, 8, 4, false, true>), dim3(blocks), dim3(threads), 0, stream, outGrads.getDevData(), denoms.getDevData(), inputs.getDevData(), acts.getDevData(),
                                                                                  target.getDevData(), imgSize, numFilters, numImages, sizeX, powScale,
                                                                                  scaleTargets, scaleOutput);
                }
            } else {
                if (scaleTargets == 0 && scaleOutput == 1) {
                    ...
                    hipLaunchKernel(HIP_KERNEL_NAME(kRNormUndo2<16, 8, 4, true, false>), dim3(blocks), dim3(threads), 0, stream, outGrads.getDevData(), denoms.getDevData(), inputs.getDevData(), acts.getDevData(),
                                                                                  target.getDevData(), imgSize, numFilters, numImages, sizeX, powScale,
                                                                                  scaleTargets, scaleOutput);
                } else {
                    hipFuncSetCacheConfig(kRNormUndo2<16, 8, 4, false, false>, hipFuncCachePreferL1);
                    hipLaunchKernel(HIP_KERNEL_NAME(kRNormUndo2<16, 8, 4, false, false>), dim3(blocks), dim3(threads), 0, stream, outGrads.getDevData(), denoms.getDevData(), inputs.getDevData(), acts.getDevData(),
                                                                                  target.getDevData(), imgSize, numFilters, numImages, sizeX, powScale,
                                                                                  scaleTargets, scaleOutput);
                }
            }
            ...
            if (checkCaseBounds) {
                if (scaleTargets == 0 && scaleOutput == 1) {
                    ...
                    hipLaunchKernel(HIP_KERNEL_NAME(kRNormUndo2<16, 4, 4, true, true>), dim3(blocks), dim3(threads), 0, stream, outGrads.getDevData(), denoms.getDevData(), inputs.getDevData(), acts.getDevData(),
                                                                                  target.getDevData(), imgSize, numFilters, numImages, sizeX, powScale,
                                                                                  scaleTargets, scaleOutput);
                } else {
                    hipFuncSetCacheConfig(kRNormUndo2<16, 4, 4, false, true>, hipFuncCachePreferL1);
                    hipLaunchKernel(HIP_KERNEL_NAME(kRNormUndo2<16, 4, 4, false, true>), dim3(blocks), dim3(threads), 0, stream, outGrads.getDevData(), denoms.getDevData(), inputs.getDevData(), acts.getDevData(),
                                                                                  target.getDevData(), imgSize, numFilters, numImages, sizeX, powScale,
                                                                                  scaleTargets, scaleOutput);
                }
            } else {
                if (scaleTargets == 0 && scaleOutput == 1) {
                    ...
                    hipLaunchKernel(HIP_KERNEL_NAME(kRNormUndo2<16, 4, 4, true, false>), dim3(blocks), dim3(threads), 0, stream, outGrads.getDevData(), denoms.getDevData(), inputs.getDevData(), acts.getDevData(),
                                                                                  target.getDevData(), imgSize, numFilters, numImages, sizeX, powScale,
                                                                                  scaleTargets, scaleOutput);
                } else {
                    hipFuncSetCacheConfig(kRNormUndo2<16, 4, 4, false, false>, hipFuncCachePreferL1);
                    hipLaunchKernel(HIP_KERNEL_NAME(kRNormUndo2<16, 4, 4, false, false>), dim3(blocks), dim3(threads), 0, stream, outGrads.getDevData(), denoms.getDevData(), inputs.getDevData(), acts.getDevData(),
                                                                                  target.getDevData(), imgSize, numFilters, numImages, sizeX, powScale,
                                                                                  scaleTargets, scaleOutput);
                }
            }
            ...
            if (checkCaseBounds) {
                if (scaleTargets == 0 && scaleOutput == 1) {
                    ...
                    hipLaunchKernel(HIP_KERNEL_NAME(kRNormUndo2<16, 2, 4, true, true>), dim3(blocks), dim3(threads), 0, stream, outGrads.getDevData(), denoms.getDevData(), inputs.getDevData(), acts.getDevData(),
                                                                                  target.getDevData(), imgSize, numFilters, numImages, sizeX, powScale,
                                                                                  scaleTargets, scaleOutput);
                } else {
                    hipFuncSetCacheConfig(kRNormUndo2<16, 2, 4, false, true>, hipFuncCachePreferL1);
                    hipLaunchKernel(HIP_KERNEL_NAME(kRNormUndo2<16, 2, 4, false, true>), dim3(blocks), dim3(threads), 0, stream, outGrads.getDevData(), denoms.getDevData(), inputs.getDevData(), acts.getDevData(),
                                                                                  target.getDevData(), imgSize, numFilters, numImages, sizeX, powScale,
                                                                                  scaleTargets, scaleOutput);
                }
            } else {
                if (scaleTargets == 0 && scaleOutput == 1) {
                    ...
                    hipLaunchKernel(HIP_KERNEL_NAME(kRNormUndo2<16, 2, 4, true, false>), dim3(blocks), dim3(threads), 0, stream, outGrads.getDevData(), denoms.getDevData(), inputs.getDevData(), acts.getDevData(),
                                                                                  target.getDevData(), imgSize, numFilters, numImages, sizeX, powScale,
                                                                                  scaleTargets, scaleOutput);
                } else {
                    hipFuncSetCacheConfig(kRNormUndo2<16, 2, 4, false, false>, hipFuncCachePreferL1);
                    hipLaunchKernel(HIP_KERNEL_NAME(kRNormUndo2<16, 2, 4, false, false>), dim3(blocks), dim3(threads), 0, stream, outGrads.getDevData(), denoms.getDevData(), inputs.getDevData(), acts.getDevData(),
                                                                                  target.getDevData(), imgSize, numFilters, numImages, sizeX, powScale,
                                                                                  scaleTargets, scaleOutput);
                }
            }
        ...
        if (imgsPerThread == 4) {
            if (checkCaseBounds) {
                ...
                hipLaunchKernel(HIP_KERNEL_NAME(kRNormUndo<4, 32, 4, 2, true>), dim3(blocks), dim3(threads), 0, stream, outGrads.getDevData(), denoms.getDevData(), inputs.getDevData(), acts.getDevData(),
                                                                          target.getDevData(), imgSize, numFilters, numImages, sizeX, powScale,
                                                                          scaleTargets, scaleOutput);
            } else {
                hipFuncSetCacheConfig(kRNormUndo<4, 32, 4, 2, false>, hipFuncCachePreferL1);
                hipLaunchKernel(HIP_KERNEL_NAME(kRNormUndo<4, 32, 4, 2, false>), dim3(blocks), dim3(threads), 0, stream, outGrads.getDevData(), denoms.getDevData(), inputs.getDevData(), acts.getDevData(),
                                                                          target.getDevData(), imgSize, numFilters, numImages, sizeX, powScale,
                                                                          scaleTargets, scaleOutput);
            }
        } else {
            if (checkCaseBounds) {
                ...
                hipLaunchKernel(HIP_KERNEL_NAME(kRNormUndo<4, 32, 1, 2, true>), dim3(blocks), dim3(threads), 0, stream, outGrads.getDevData(), denoms.getDevData(), inputs.getDevData(), acts.getDevData(),
                                                                          target.getDevData(), imgSize, numFilters, numImages, sizeX, powScale,
                                                                          scaleTargets, scaleOutput);
            } else {
                hipFuncSetCacheConfig(kRNormUndo<4, 32, 1, 2, false>, hipFuncCachePreferL1);
                hipLaunchKernel(HIP_KERNEL_NAME(kRNormUndo<4, 32, 1, 2, false>), dim3(blocks), dim3(threads), 0, stream, outGrads.getDevData(), denoms.getDevData(), inputs.getDevData(), acts.getDevData(),
                                                                          target.getDevData(), imgSize, numFilters, numImages, sizeX, powScale,
                                                                          scaleTargets, scaleOutput);
            }
        }
...
void convResizeBilinear(NVMatrix& images, NVMatrix& target, int imgSize, int tgtSize, float scale) {
    ...
    if (imgsPerThread == 4) {
        if (checkCaseBounds) {
            ...
            hipLaunchKernel(HIP_KERNEL_NAME(kResizeBilinear<4, true>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), target.getDevData(), imgSize, tgtSize, numImages, images.getStride(), scale, centerScale);
        } else {
            hipFuncSetCacheConfig(kResizeBilinear<4, false>, hipFuncCachePreferL1);
            hipLaunchKernel(HIP_KERNEL_NAME(kResizeBilinear<4, false>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), target.getDevData(), imgSize, tgtSize, numImages, images.getStride(), scale, centerScale);
        }
    } else if (imgsPerThread == 2) {
        if (checkCaseBounds) {
            hipFuncSetCacheConfig(kResizeBilinear<2, true>, hipFuncCachePreferL1);
            hipLaunchKernel(HIP_KERNEL_NAME(kResizeBilinear<2, true>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), target.getDevData(), imgSize, tgtSize, numImages, images.getStride(), scale, centerScale);
        } else {
            hipFuncSetCacheConfig(kResizeBilinear<2, false>, hipFuncCachePreferL1);
            hipLaunchKernel(HIP_KERNEL_NAME(kResizeBilinear<2, false>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), target.getDevData(), imgSize, tgtSize, numImages, images.getStride(), scale, centerScale);
        }
    } else {
        if (checkCaseBounds) {
            hipFuncSetCacheConfig(kResizeBilinear<1, true>, hipFuncCachePreferL1);
            hipLaunchKernel(HIP_KERNEL_NAME(kResizeBilinear<1, true>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), target.getDevData(), imgSize, tgtSize, numImages, images.getStride(), scale, centerScale);
        } else {
            hipFuncSetCacheConfig(kResizeBilinear<1, false>, hipFuncCachePreferL1);
            hipLaunchKernel(HIP_KERNEL_NAME(kResizeBilinear<1, false>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), target.getDevData(), imgSize, tgtSize, numImages, images.getStride(), scale, centerScale);
        }
    }
...
void convRGBToYUV(NVMatrix& images, NVMatrix& target) {
    ...
    if (imgsPerThread == 4) {
        if (checkCaseBounds) {
            ...
            hipLaunchKernel(HIP_KERNEL_NAME(kRGBToYUV<4, true>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), target.getDevData(), imgPixels, numImages, images.getStride());
        } else {
            hipFuncSetCacheConfig(kRGBToYUV<4, false>, hipFuncCachePreferL1);
            hipLaunchKernel(HIP_KERNEL_NAME(kRGBToYUV<4, false>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), target.getDevData(), imgPixels, numImages, images.getStride());
        }
    } else if (imgsPerThread == 2) {
        if (checkCaseBounds) {
            hipFuncSetCacheConfig(kRGBToYUV<2, true>, hipFuncCachePreferL1);
            hipLaunchKernel(HIP_KERNEL_NAME(kRGBToYUV<2, true>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), target.getDevData(), imgPixels, numImages, images.getStride());
        } else {
            hipFuncSetCacheConfig(kRGBToYUV<2, false>, hipFuncCachePreferL1);
            hipLaunchKernel(HIP_KERNEL_NAME(kRGBToYUV<2, false>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), target.getDevData(), imgPixels, numImages, images.getStride());
        }
    } else {
        if (checkCaseBounds) {
            hipFuncSetCacheConfig(kRGBToYUV<1, true>, hipFuncCachePreferL1);
            hipLaunchKernel(HIP_KERNEL_NAME(kRGBToYUV<1, true>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), target.getDevData(), imgPixels, numImages, images.getStride());
        } else {
            hipFuncSetCacheConfig(kRGBToYUV<1, false>, hipFuncCachePreferL1);
            hipLaunchKernel(HIP_KERNEL_NAME(kRGBToYUV<1, false>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), target.getDevData(), imgPixels, numImages, images.getStride());
        }
    }
    ...
    if (imgsPerThread == 4) {
        if (center) {
            if (checkCaseBounds) {
                ...
                hipLaunchKernel(HIP_KERNEL_NAME(kRGBToLAB<4, true, true>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), target.getDevData(), imgPixels, numImages, images.getStride());
            } else {
                hipFuncSetCacheConfig(kRGBToLAB<4, false, true>, hipFuncCachePreferL1);
                hipLaunchKernel(HIP_KERNEL_NAME(kRGBToLAB<4, false, true>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), target.getDevData(), imgPixels, numImages, images.getStride());
            }
        } else {
            if (checkCaseBounds) {
                hipFuncSetCacheConfig(kRGBToLAB<4, true, false>, hipFuncCachePreferL1);
                hipLaunchKernel(HIP_KERNEL_NAME(kRGBToLAB<4, true, false>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), target.getDevData(), imgPixels, numImages, images.getStride());
            } else {
                hipFuncSetCacheConfig(kRGBToLAB<4, false, false>, hipFuncCachePreferL1);
                hipLaunchKernel(HIP_KERNEL_NAME(kRGBToLAB<4, false, false>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), target.getDevData(), imgPixels, numImages, images.getStride());
            }
        }
    } else if (imgsPerThread == 2) {
        if (center) {
            if (checkCaseBounds) {
                ...
                hipLaunchKernel(HIP_KERNEL_NAME(kRGBToLAB<2, true, true>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), target.getDevData(), imgPixels, numImages, images.getStride());
            } else {
                hipFuncSetCacheConfig(kRGBToLAB<2, false, true>, hipFuncCachePreferL1);
                hipLaunchKernel(HIP_KERNEL_NAME(kRGBToLAB<2, false, true>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), target.getDevData(), imgPixels, numImages, images.getStride());
            }
        } else {
            if (checkCaseBounds) {
                hipFuncSetCacheConfig(kRGBToLAB<2, true, false>, hipFuncCachePreferL1);
                hipLaunchKernel(HIP_KERNEL_NAME(kRGBToLAB<2, true, false>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), target.getDevData(), imgPixels, numImages, images.getStride());
            } else {
                hipFuncSetCacheConfig(kRGBToLAB<2, false, false>, hipFuncCachePreferL1);
                hipLaunchKernel(HIP_KERNEL_NAME(kRGBToLAB<2, false, false>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), target.getDevData(), imgPixels, numImages, images.getStride());
            }
        }
    } else {
        if (center) {
            if (checkCaseBounds) {
                ...
                hipLaunchKernel(HIP_KERNEL_NAME(kRGBToLAB<1, true, true>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), target.getDevData(), imgPixels, numImages, images.getStride());
            } else {
                hipFuncSetCacheConfig(kRGBToLAB<1, false, true>, hipFuncCachePreferL1);
                hipLaunchKernel(HIP_KERNEL_NAME(kRGBToLAB<1, false, true>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), target.getDevData(), imgPixels, numImages, images.getStride());
            }
        } else {
            if (checkCaseBounds) {
                hipFuncSetCacheConfig(kRGBToLAB<1, true, false>, hipFuncCachePreferL1);
                hipLaunchKernel(HIP_KERNEL_NAME(kRGBToLAB<1, true, false>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), target.getDevData(), imgPixels, numImages, images.getStride());
            } else {
                hipFuncSetCacheConfig(kRGBToLAB<1, false, false>, hipFuncCachePreferL1);
                hipLaunchKernel(HIP_KERNEL_NAME(kRGBToLAB<1, false, false>), dim3(blocks), dim3(threads), 0, stream, images.getDevData(), target.getDevData(), imgPixels, numImages, images.getStride());
            }
        }
    }
...
void convCrop(NVMatrix& imgs, NVMatrix& target, int imgSize, int tgtSize, int startY, int startX) {
    ...
    if (imgsPerThread == 4) {
        if (checkCaseBounds) {
            hipLaunchKernel(HIP_KERNEL_NAME(kCrop<4, true>), dim3(blocks), dim3(threads), 0, stream, imgs.getDevData(), target.getDevData(), numImages, imgs.getStride(), imgSize, tgtSize, startY, startX);
        } else {
            hipLaunchKernel(HIP_KERNEL_NAME(kCrop<4, false>), dim3(blocks), dim3(threads), 0, stream, imgs.getDevData(), target.getDevData(), numImages, imgs.getStride(), imgSize, tgtSize, startY, startX);
        }
    } else if (imgsPerThread == 2) {
        if (checkCaseBounds) {
            hipLaunchKernel(HIP_KERNEL_NAME(kCrop<2, true>), dim3(blocks), dim3(threads), 0, stream, imgs.getDevData(), target.getDevData(), numImages, imgs.getStride(), imgSize, tgtSize, startY, startX);
        } else {
            hipLaunchKernel(HIP_KERNEL_NAME(kCrop<2, false>), dim3(blocks), dim3(threads), 0, stream, imgs.getDevData(), target.getDevData(), numImages, imgs.getStride(), imgSize, tgtSize, startY, startX);
        }
    } else {
        if (checkCaseBounds) {
            hipLaunchKernel(HIP_KERNEL_NAME(kCrop<1, true>), dim3(blocks), dim3(threads), 0, stream, imgs.getDevData(), target.getDevData(), numImages, imgs.getStride(), imgSize, tgtSize, startY, startX);
        } else {
            hipLaunchKernel(HIP_KERNEL_NAME(kCrop<1, false>), dim3(blocks), dim3(threads), 0, stream, imgs.getDevData(), target.getDevData(), numImages, imgs.getStride(), imgSize, tgtSize, startY, startX);
        }
    }
...
//            images.getDevData(), meanDiffs.getDevData(), denoms.getDevData(), target.getDevData(), imgSize, numFilters, numImages, sizeF, addScale, powScale, minDiv, blocked);
    if (blocked) {
        if (checkCaseBounds) {
            ...
            hipLaunchKernel(HIP_KERNEL_NAME(kFCNorm<4, 32, 4, true, true>), dim3(blocks), dim3(threads), 0, stream, images.getTextureObject(), meanDiffs.getTextureObject(), target.getDevData(),
            ...
            hipLaunchKernel(HIP_KERNEL_NAME(kFCNorm<4, 32, 4, false, true>), dim3(blocks), dim3(threads), 0, stream, images.getTextureObject(), meanDiffs.getTextureObject(), target.getDevData(),
                                                                imgSize, numFilters, numImages, sizeF, addScale, powScale, minDiv);
        }
    } else {
        if (checkCaseBounds) {
            hipFuncSetCacheConfig(kFCNorm<4, 32, 4, true, false>, hipFuncCachePreferL1);
            hipLaunchKernel(HIP_KERNEL_NAME(kFCNorm<4, 32, 4, true, false>), dim3(blocks), dim3(threads), 0, stream, images.getTextureObject(), meanDiffs.getTextureObject(), target.getDevData(),
                                                                imgSize, numFilters, numImages, sizeF, addScale, powScale, minDiv);
        } else {
            hipFuncSetCacheConfig(kFCNorm<4, 32, 4, false, false>, hipFuncCachePreferL1);
            hipLaunchKernel(HIP_KERNEL_NAME(kFCNorm<4, 32, 4, false, false>), dim3(blocks), dim3(threads), 0, stream, images.getTextureObject(), meanDiffs.getTextureObject(), target.getDevData(),
                                                                imgSize, numFilters, numImages, sizeF, addScale, powScale, minDiv);
        }
    }
    ...
    if (blocked) {
        if (scaleTargets == 0 && scaleOutput == 1) {
            if (checkCaseBounds) {
                ...
                hipLaunchKernel(HIP_KERNEL_NAME(kFRNormUndo2<4, 32, 4, false, true, true>), dim3(blocks2), dim3(threads2), 0, stream, outGrads.getTextureObject(), inputs.getTextureObject(), acts.getTextureObject(),
                ...
                hipLaunchKernel(HIP_KERNEL_NAME(kFRNormUndo2<4, 32, 4, false, false, true>), dim3(blocks2), dim3(threads2), 0, stream, outGrads.getTextureObject(), inputs.getTextureObject(), acts.getTextureObject(),
                                                                        target.getDevData(), imgSize, numFilters, numImages, sizeF, addScale, powScale, minDiv,
                                                                        scaleTargets, scaleOutput);
            }
        } else {
            if (checkCaseBounds) {
                ...
                hipLaunchKernel(HIP_KERNEL_NAME(kFRNormUndo2<4, 32, 4, true, true, true>), dim3(blocks2), dim3(threads2), 0, stream, outGrads.getTextureObject(), inputs.getTextureObject(), acts.getTextureObject(),
                                                                        target.getDevData(), imgSize, numFilters, numImages, sizeF, addScale, powScale, minDiv,
                                                                        scaleTargets, scaleOutput);
            } else {
                hipFuncSetCacheConfig(kFRNormUndo2<4, 32, 4, true, false, true>, hipFuncCachePreferL1);
                hipLaunchKernel(HIP_KERNEL_NAME(kFRNormUndo2<4, 32, 4, true, false, true>), dim3(blocks2), dim3(threads2), 0, stream, outGrads.getTextureObject(), inputs.getTextureObject(), acts.getTextureObject(),
                                                                        target.getDevData(), imgSize, numFilters, numImages, sizeF, addScale, powScale, minDiv,
                                                                        scaleTargets, scaleOutput);
            }
        }
        ...
        if (scaleTargets == 0 && scaleOutput == 1) {
            if (checkCaseBounds) {
                ...
                hipLaunchKernel(HIP_KERNEL_NAME(kFRNormUndo2<4, 32, 4, false, true, false>), dim3(blocks2), dim3(threads2), 0, stream, outGrads.getTextureObject(), inputs.getTextureObject(), acts.getTextureObject(),
                                                                        target.getDevData(), imgSize, numFilters, numImages, sizeF, addScale, powScale, minDiv,
                                                                        scaleTargets, scaleOutput);
            } else {
                hipFuncSetCacheConfig(kFRNormUndo2<4, 32, 4, false, false, false>, hipFuncCachePreferL1);
                hipLaunchKernel(HIP_KERNEL_NAME(kFRNormUndo2<4, 32, 4, false, false, false>), dim3(blocks2), dim3(threads2), 0, stream, outGrads.getTextureObject(), inputs.getTextureObject(), acts.getTextureObject(),
                                                                        target.getDevData(), imgSize, numFilters, numImages, sizeF, addScale, powScale, minDiv,
                                                                        scaleTargets, scaleOutput);
            }
        } else {
            if (checkCaseBounds) {
                ...
                hipLaunchKernel(HIP_KERNEL_NAME(kFRNormUndo2<4, 32, 4, true, true, false>), dim3(blocks2), dim3(threads2), 0, stream, outGrads.getTextureObject(), inputs.getTextureObject(), acts.getTextureObject(),
                                                                        target.getDevData(), imgSize, numFilters, numImages, sizeF, addScale, powScale, minDiv,
                                                                        scaleTargets, scaleOutput);
            } else {
                hipFuncSetCacheConfig(kFRNormUndo2<4, 32, 4, true, false, false>, hipFuncCachePreferL1);
                hipLaunchKernel(HIP_KERNEL_NAME(kFRNormUndo2<4, 32, 4, true, false, false>), dim3(blocks2), dim3(threads2), 0, stream, outGrads.getTextureObject(), inputs.getTextureObject(), acts.getTextureObject(),
                                                                        target.getDevData(), imgSize, numFilters, numImages, sizeF, addScale, powScale, minDiv,
                                                                        scaleTargets, scaleOutput);
            }
        }
